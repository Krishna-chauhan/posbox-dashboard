...
module.exports = {
  /* 01.General */
  'general.copyright': 'pobox©2025 All Rights Reserved.',
  ...
  'admin.polling-stations': 'Polling Stations',
  'admin.users': 'Users',
  'admin.authentication.title': 'Authentication Settings',
  'admin.authentication.settings': 'Security Settings',
  'admin.authentication.session-timeout': 'Session Timeout',
  'admin.authentication.max-login-attempts': 'Max Login Attempts',
  'admin.authentication.password-policy': 'Password Policy',
  'admin.authentication.require-uppercase': 'Require Uppercase',
  'admin.authentication.require-lowercase': 'Require Lowercase',
  'admin.authentication.require-numbers': 'Require Numbers',
  'admin.authentication.require-special-chars': 'Require Special Characters',
  'admin.authentication.two-factor-auth': 'Two-Factor Authentication',
  'admin.authentication.active-sessions': 'Active Sessions',
  'admin.elections.title': 'Election Management',
  'admin.elections.create': 'Create Election',
  'admin.elections.list': 'Elections List',
  'admin.polling-stations.title': 'Polling Station Management',
  'admin.polling-stations.create': 'Create Polling Station',
  'admin.polling-stations.list': 'Polling Stations List',
  'admin.users.title': 'User Management',
  'admin.users.create': 'Create User',
  'admin.users.list': 'Users List',
  'menu.user-dashboard': 'User Dashboard',
  'menu.elections': 'Elections',
  'menu.polling-stations': 'Polling Stations',
  'user.dashboard.title': 'User Dashboard',
  'user.dashboard.profile': 'My Profile',
  'user.dashboard.active-elections': 'Active Elections',
  'user.dashboard.quick-actions': 'Quick Actions',
  'user.dashboard.view-elections': 'View Elections',
  ...
  'polling-stations.list': 'Polling Stations List',
  'menu.modal': 'Modal',
